...
//-------------------------------
// This script applies the changes made in Stitcher16 (color filtering, removal of normal calculations, etc),
// but also matches cylinders to stalks and commands the arm to those cylinders 
//-------------------------------
...
private:
	...
	//------------Cloud Slicing------------
	const static int rMin_slice = 99; 
	const static int gMin_slice = 115;
	const static int bMin_slice = 56;
