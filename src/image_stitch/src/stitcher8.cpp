...
//---------Create a conditional removal filter to remove black pixels---------
	    ...
	    if (i>0)
	    {
	        ...
	        //std::cout << "Global Tform 1: " << GlobalTransform << std::endl;
...
int main(int argc, char** argv)
{
	...
	Stitch* pStitch = new Stitch;
  	...
  	ros::ServiceServer service = n.advertiseService("cloud_stitch", &Stitch::cloudStitch, pStitch);
	...
	/*
	while(pStitch->globalCounter<5 && ros::ok()){ 
		ros::spinOnce();
	}
	*/
