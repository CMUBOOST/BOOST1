...
int sendJointCommands(double position23, double velocity22, double position21)
{
  ...
  cmd[0].actuatorCommand().setVelocity(NAN);
  cmd[1].actuatorCommand().setVelocity(NAN);
  cmd[2].actuatorCommand().setVelocity(NAN);
  cmd[3].actuatorCommand().setVelocity(NAN);
  cmd[4].actuatorCommand().setPosition(motor21);
  cmd[5].actuatorCommand().setVelocity(motor22);
  cmd[6].actuatorCommand().setPosition(motor23);
  //cmd[4].actuatorCommand().setPosition(motor21);
  //cmd[5].actuatorCommand().setVelocity(motor22);
  //cmd[6].actuatorCommand().setPosition(motor23);
  group_g->sendCommand(cmd);
  std::cerr << "Joint Commands:\t" << motor21 <<
            "\t" << motor22 << "\t" << motor23 << ".\n";
...
int main(int argc, char **argv)
{
  ...
  hebi::GroupCommand cmd(7);
  cmd[0].actuatorCommand().setPosition((nan(""), nan(""), nan(""), nan(""), nan(""), nan(""), nan("")));
  cmd[1].actuatorCommand().setVelocity((nan(""), nan(""), nan(""), nan(""), nan(""), nan(""), nan("")));
  cmd[2].actuatorCommand().setTorque((nan(""), nan(""), nan(""), nan(""), nan(""), nan(""), nan("")));
  group_g->sendCommand(cmd);

  std::cout << "Zero'd out all motors" << std::endl;
