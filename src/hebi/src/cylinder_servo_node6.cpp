...
public:
  ...
  void callback(const sensor_msgs::JointState::ConstPtr& jointStatePtr)
  {
    ...
    //float hyp = 0.3;
    float joint2_x = hyp*cos(jointStatePtr->position[0]);
    float joint2_y = hyp*sin(jointStatePtr->position[0]);
    ...
    float camera_x = hyp_camera*cos(jointStatePtr->position[0] + jointStatePtr->position[2]) + joint2_x;
    float camera_y = hyp_camera*sin(jointStatePtr->position[0] + jointStatePtr->position[2]) + joint2_y;
    ...
    if (counter<50)
    {
        ...
        if (direction == "left")
        {
            ROS_DEBUG_STREAM("Desired Angle of joint2: " << (jointStatePtr->position[2] + theta));
            ...
            pointAtPlant = jointStatePtr->position[2] - line_diff;
        }
        else
        {
            ROS_DEBUG_STREAM("Desired Angle of joint2: " << (jointStatePtr->position[2] + theta));
    ...
    else
    {
        ...
        */
        ...
        else if (idleFlag == 0)
        {
            ...
            //Calculate camera position (I could subscribe to the topic but this is easier)
            camera_x = hyp_camera*cos(command1 + jointStatePtr->position[2]) + joint2_x;
            camera_y = hyp_camera*sin(command1 + jointStatePtr->position[2]) + joint2_y;
            ROS_DEBUG_STREAM("Camera_x: " << camera_x << ", Camera_y: " << camera_y);
            ...
            output.position.push_back(jointStatePtr->position[2] - line_diff);
